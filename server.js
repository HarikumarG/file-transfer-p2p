...
app.use(favicon(__dirname + '/client/assets/paper.png'));
...
app.get("/tunnel/:tunnelId", function (req, res) {
  ...
  if (tunnelId in tunnels) {
    ...
    res.on("close", function () {
      if (tunnels[tunnelId] != true) {
        tunnels[tunnelId] = true;
      }
    });
